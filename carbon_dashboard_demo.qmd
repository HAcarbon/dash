...
library(leaflet)
  ...
  office_icon = makeIcon("images/nl_agridat_hex_tp.png","images/nl_agridat_hex_tp.png", 50, 50)
...
leaflet(carbon_data) %>%
  ...
  addMarkers(lng=-2.432260, lat=52.779504, popup ="Click the animal icons for info!", icon =office_icon) %>%
