...
data_dict <- read_xlsx("www/Carbon_data_agrecalc_v02.xlsx", sheet = 5, skip = 7, n_max = 74)

other_dict <- read_xlsx("www/Carbon_data_agrecalc_v02.xlsx", sheet = 5, skip = 83, col_names = FALSE) %>%
  select(`...1`, `...4`) %>%
  rename(sector = `...1`,
         Description = `...4`)
